          ...
          {loading ? (
            <div className="flex flex-col items-center justify-center h-full">
              <div className="relative w-10 h-10 mb-5">
                <div className="absolute inset-0 rounded-full border border-purple-500/20 animate-[pulse-ring_1.8s_ease-out_infinite]" />
                <div className="absolute inset-0 rounded-full border border-transparent border-t-purple-500 animate-spin" />
              </div>
              <p className="text-zinc-600 text-sm font-medium">Loading projects...</p>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="relative shrink-0">
                        ...
                        <div className={`absolute top-3 left-3 z-20 transition-opacity duration-200 ${isConfirming ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'}`}>
                          {!isConfirming ? (
                            <button
                            ...
                            <div
                              className="flex items-center gap-1 bg-black/80 backdrop-blur-sm border border-red-500/25 rounded-lg px-2 py-1"
                              onClick={(e) => { e.preventDefault(); e.stopPropagation() }}
                            >
                              <span className="text-[10px] text-zinc-300 font-medium mr-0.5">Sure?</span>
                              <button
                              ...
                              <button
                                ...
                                className="text-[10px] font-bold text-zinc-400 hover:text-zinc-200 transition-colors px-1"
                              >
                                No
                              </button>
                            </div>
